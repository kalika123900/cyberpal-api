...
class AuthController extends Controller
{
    public function adminLogin (Request $request)
    {
        ...
        try {
            if (auth()->attempt($credentials)) {
                ...
                if (!empty($user->user_type) && $user->user_type === 'admin') {
                ...
                } else throw new \Exception('You are not a admin');
    ...
    function getlocale(Request $request)
    {
        ...
        $key = '2239e12a07eee780fa5cbc7217883526';
        ...
        curl_setopt($cURLConnection, CURLOPT_URL, "http://api.ipstack.com/$ip?access_key=2239e12a07eee780fa5cbc7217883526");
        ...
        $countryCode =  $jsonArrayResponse->country_code;
